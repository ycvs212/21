...
namespace myTiles {
    ...
    helpers._registerFactory("tilemap", function(name: string) {
        switch(helpers.stringTrim(name)) {
            case "層級1":
            case "層級1":return tiles.createTilemap(hex`0a00070003010101010101010102080a09090a0a09090a04080a09090a09090909040809090a09090a09090408090909090a09090a0409090a090a0909090a040706060606060a060605`, img`
. . . . . . . . . . 
. 2 . . 2 2 . . 2 . 
. 2 . . 2 . . . . . 
. . . 2 . . 2 . . . 
